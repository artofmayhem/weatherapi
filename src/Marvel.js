...
export default function Marvel(props) {
  ...
  console.log(`${datadig[0].thumbnail.path}.${datadig[0].thumbnail.extension}`);
  return (
    <div className="d-flex flex-column" style={{ flexDirection: "wrap" }}>
      <h3 className='display-4' style={{ textShadow: "0 0 1rem #aaa", padding: "5rem 0", alignSelf: 'center' }}>
        Avengers Information Hub
      </h3>{" "}
      ...
      <div className='d-flex justify-content-center'><img src={stark} alt="stark logo" style={{maxWidth: '30%', alignSelf: 'center', opacity: '0.8'}}></img></div>
    </div>
  );
}
