    ...
    >
      ...
      >
        <form className="d-flex justify-content-center">
          ...
          >
            <p className="display-1"> Hello, Mr.Stark... </p>{" "}
            <h5> Welcome to Jarvis 2.0.Your Personal Data Assistant </h5>{" "}
            ...
            >
              Your current date and time is {localTime} in the{" "}
              {timeZone}
              timezone{" "}
            </h5>{" "}
      ...
      >
       ...
       <p style={{ padding: "0 5rem" }}>
          Today's cloud coverage in {name2} is {cloud}%{" "}
          and {text}
        </p>
        <br></br>
        <p>
       ...
       <Astronomy data={astro} /> <Forecast data={foreCast} />{" "}
        <div className="d-flex justify-content-center flex-column">
          <h3 className='display-4' style={{ padding: "5rem 0", alignSelf: 'center' }}>
            Suit Prototype Specs For Your Review{" "}
          </h3>
          <img src={reactortrans} alt='reactor' style={{maxWidth: '30vw', alignSelf: 'center', padding: '5rem 0'}}></img>
          <div className="d-flex justify-content-around flex-row" style={{padding: '5rem 0'}}>
            <img src={ironman1} style={{ width: "30vw" }} alt="suit one" />
            <img src={ironman2} style={{ width: "30vw" }} alt="suit one" />
          </div>
        </div>
